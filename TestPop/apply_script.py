...
if __name__ == '__main__':
    ...
    paths = ['scripted_guis', 'run.txt', 'census', 'death', 'regiments']
    outpaths = ['common\\scripted_guis\\01_economy.txt', 'out.txt', 'events\\census.txt', 'events\\death.txt', 'events\\regiments.txt']
